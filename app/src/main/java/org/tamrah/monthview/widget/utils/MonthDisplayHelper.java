package org.tamrah.monthview.widget.utils;

import java.util.Calendar;

/**
 * Created by abdullah on 5/14/16.
 */
public class MonthDisplayHelper {
    ...
    public int getDayAt(int position){
        return getDayAt(position / 7, position % 7);
    }
    ...
    public boolean isWithinCurrentMonth(int position){
        return isWithinCurrentMonth(position / 7, position % 7);
    }
